...
firebase.initializeApp({
  apiKey: "AIzaSyArtdzusID5iFg8hBdykuHcE_mmrO9cGsA",
  authDomain: "react-chat-app-1d9e9.firebaseapp.com",
  projectId: "react-chat-app-1d9e9",
  storageBucket: "react-chat-app-1d9e9.appspot.com",
  messagingSenderId: "224709695259",
  appId: "1:224709695259:web:4a18419449dcbdfc2fa5be",
});
...
function App() {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-coolDark-500 dark:text-white transition-colors">
      ...
      >
        <a href="https://www.youtube.com/channel/UCIoDSti-1s_QRv-gXXjJ-eA">
          <img src={brandLogo} alt="Madesh" width={150} />
        </a>
